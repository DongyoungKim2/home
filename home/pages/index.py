        ...
        pc.vstack(
            pc.vstack(
                ...
                pc.vstack(
                    ...
                    pc.box(
                        pc.text("INDUSTRY", font_size="3em", font_weight=100,),
                        width="80%",
                    ),
                    color="white",
                    width="100%",
                        ...
                        pc.flex(
                            ...
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("OCR Models (2022)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                            ...
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("Data Lake (2021)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                            ...
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("SLI-OCR (2021)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                        ...
                        pc.flex(
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("GraphDB (2021)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                            ...
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("Dx-figet (2021)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                        ...
                        pc.flex(
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("EV-IDENT (2020)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
                            ...
                            pc.tooltip(
                                pc.vstack(
                                    ...
                                    pc.text("HER2/HER3 (2016)", as_="strong"),
                                    style={"cursor": "pointer"},
                                ),
